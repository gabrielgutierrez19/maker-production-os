...
- ElevenLabs voice briefing recorded for each incident when a voice key is configured; the dashboard checks for new incidents every five seconds and makes the briefing playable in place
